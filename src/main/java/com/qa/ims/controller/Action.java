 ...
 */
public enum Action {
	CREATE("To save a new entity into the database"), READALL("To read everything from the database"),
	UPDATE("To change an entity already in the database"), DELETE("To remove an entity from the database"),
	READBYID("Read one entity in the database by ID"),   RETURN("To return to domain selection");
